...
```
$ curl -sSfL https://raw.githubusercontent.com/suzuki-shunsuke/aqua-installer/v0.2.0/aqua-installer | bash -s -- -v v0.7.8 -i bin/aqua
```
...
- uses: suzuki-shunsuke/aqua-installer@v0.2.0
  with:
    version: v0.7.8 # renovate: depName=suzuki-shunsuke/aqua
