...
```
$ curl -sSfL https://raw.githubusercontent.com/suzuki-shunsuke/aqua-installer/v0.1.3/aqua-installer | bash -s -- -v v0.5.3 -i bin/aqua
```
...
- uses: suzuki-shunsuke/aqua-installer@v0.1.3
  with:
    version: v0.5.3 # renovate: depName=suzuki-shunsuke/aqua
