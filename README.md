...
```
$ curl -sSfL https://raw.githubusercontent.com/aquaproj/aqua-installer/v0.3.0/aqua-installer | bash -s -- -v v0.8.2 -i bin/aqua
```
...
- uses: aquaproj/aqua-installer@v0.3.0
  with:
    version: v0.8.2 # renovate: depName=aquaproj/aqua
